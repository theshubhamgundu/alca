...
const ShippingPolicy: React.FC = () => {
  usePageSEO({
    title: 'Shipping Policy | ALCA',
    description: 'ALCA Shipping Policy — all orders dispatched within 24 hours. Pan-India delivery in 3–5 business days with WhatsApp tracking updates.',
    ...
    <div className="min-h-screen bg-cream/20 py-12 px-6">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl border border-cream2 shadow-sm">
        <div className="mb-8 border-b border-gray-100 pb-6">
          ...
          <p className="text-xs text-muted mt-2">Last Updated: July 24, 2026 • ALCA</p>
        </div>
        ...
        <div className="space-y-6 text-sm text-ink leading-relaxed">
          <section>
            ...
            <p>
              ALCA provides express delivery across India as well as worldwide export shipments for wholesale and bulk orders.
            </p>
          </section>
